...
and nitro state. The next native physics tick therefore observes the controls
named by the tag. The C++ capture bridge exports it into each 366-byte row as
